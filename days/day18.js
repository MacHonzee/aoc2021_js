...
function addAllLines(input) {
  ...
  for (let i = 1; i < input.length; i++) {
    ...
    console.log("-> after addition ", drawPair(rootPair));
    ...
    do {
      ...
      if (reducing) console.log("-> after " + reducing, drawPair(rootPair));
    } while (reducing);
    console.log("-> after reducing ", drawPair(rootPair));
  ...
  let rootPair = new Pair(targetArray[0], targetArray[1], null, 0);
  console.log("-> final result   ", drawPair(rootPair));
  return rootPair;
}
